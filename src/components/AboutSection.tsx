...
const ABOUT_TEXT =
  "I'm an ECE UnderGrad at CMR Institute of Technology, Hyderabad, Currently working as Full Stack Developer Intern at EvolveX Spaces and UI/UX Intern at Student Forge Technologies. I'm a passionate developer, problem solver, and tech enthusiast focused on building impactful digital experiences. From hackathons to startup environments, I continuously learn, build, and collaborate to grow as a developer and entrepreneur. On the other side i'm a Social Media Educational Influencer having 1.3L Followers on instagram, Teaches Aptitude and Reasoning.";
                    ...
                    <FadeIn delay={0.15} className="w-full max-w-3xl">
                      <div className="flex flex-col gap-5 sm:gap-6">
                        {[
                          {
                            label: 'UI/UX Related',
                            items: ['Figma', '21st.dev', 'Framer', 'Dribbble'],
                          },
                          {
                            label: 'Frontend Technologies',
                            items: ['HTML & CSS', 'JavaScript', 'Basic of TypeScript', 'Tailwind CSS', 'Next.js'],
                          },
                          {
                            label: 'Backend Technologies',
                            items: ['Python', 'Flask', 'Node.js', 'API Integration', 'Authentication & Authorization', 'REST APIs'],
                          },
                          {
                          ...
                          >
                            <span className="text-xs uppercase tracking-widest text-[#D7E2EA]/40 text-left">
                              {group.label}
                            </span>
