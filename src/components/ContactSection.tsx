...
const CONTACT_METHODS: ContactMethod[] = [
  {
    icon: Mail,
    label: 'Email',
    value: 'abhinaykalal019@gmail.com',
    href: 'mailto:abhinaykalal019@gmail.com',
  },
  {
    icon: MessageCircle,
    label: 'WhatsApp',
    ...
    href: 'https://wa.me/918125090270',
  },
  {
    icon: Linkedin,
    label: 'LinkedIn',
    value: '@Abhinay Kalal',
    href: 'https://www.linkedin.com/in/abhinaykalal',
  },
  {
    icon: Github,
    label: 'GitHub',
    value: '@Abhinay Kalal',
    href: 'https://github.com/Abhinay-kalal',
  },
  {
    icon: Instagram,
    label: 'Instagram',
    value: 'abhi.aptitude',
    href: 'https://www.instagram.com/abhi.aptitude/',
  },
];
